...
public class Unit implements IMutableUnit {
	...
	public Unit(){
		...
		skills.add(new Skill("Air Blade",     10, 2,  0, true,false));
		skills.add(new Skill("Thunder Flare", 15, 3,  1, true,false));
		skills.add(new Skill("Thunderbird",   40, 4,  2, true,false));
	}
