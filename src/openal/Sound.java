...
/**
 * A single sound effect loaded from either OGG or XM/MOD file. Sounds are allocated to channels
 * dynamically - if not channel is available the sound will not play.
 * 
 * @author kevin
 */
public class Sound {
