 ...
 * given time and a channel is reserved so music will always play.
 * 
 * @author kevin
...
public class Music {
	 ...
	 * listeners. Note that if you're using a game container this will be auto-magically called for
	 * you.
	 * 
	 * @param delta
	 *            The amount of time since last poll in milliseconds
	 */
	...
	/**
	 * Seeks to a position in the music. For streaming music, seeking before the current position
	 * causes the stream to be reloaded.
	 * 
	 * @param position
	 *            Position in seconds.
