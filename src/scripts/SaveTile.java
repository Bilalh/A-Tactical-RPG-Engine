...
public class SaveTile extends JFrame {
	...
	SaveTile(){
		...
		t = new IsoTile(Orientation.TO_EAST, 1, 1, 0, 1, "2", ImageType.TEXTURED,MapSettings.defaults(),null,null);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		IsoTile t = new IsoTile(Orientation.TO_EAST, 1, 1, 0, 1, "2", ImageType.TEXTURED,MapSettings.defaults(),null,null);
		t.draw(40, 20, g);
