...
\lstset{basicstyle=\small\ttfamily,numberstyle=\tiny,numbersep=5pt,extendedchars=true,breaklines=true}
...
\ifthenelse{\boolean{@twoside}{false}}
{
	...
	\fancyhead[CO]{\hspace{30pt}  \theTitle}
	\fancyhead[CE]{\hspace{-30pt} \theAuthor}
}{
	\fancyhead[LO,RE]{\slshape \nouppercase{\currentSection}} 
	\fancyhead[LE,RO]{\thepage} 
	\fancyhead[CO]{\hspace{30pt}  \theAuthor  \hspace{5pt}-- \theTitle}
	\fancyhead[CE]{\hspace{-50pt} \theAuthor  \hspace{5pt}-- \theTitle}
}
