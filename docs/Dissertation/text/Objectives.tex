...
\begin{itemize}
	...
	\partly Tiles that are not passable such as sea, lava, etc.
	...
	\partly Direction and height of the character's tile affects attack. \footnote{At the moment only the height affects the attack, while the direction is displayed in the GUI and changed based on the unit's movement, it not used in the model.}
