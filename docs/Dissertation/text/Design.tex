...
A isometric viewpoint is a way of display 3d objects in 2d while giving the impression that it 3d.  Two different variations are shown in figure \ref{fig:tilemap0}.  
%TODO more
