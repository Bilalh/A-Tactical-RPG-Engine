...
Prototypes were extensively used, especially in the GUI when choosing how to render the map. These also used when deciding the most appropriate layout for the editor. %TODO REF
